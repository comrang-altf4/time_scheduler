...
public class Email {
    protected static Message sendEmail(String receiver) throws MessagingException {
    ...
    protected static String sendVerificationCode(String receiver) throws MessagingException {
